...
## Quando Usar
- Quando precisar de revisão técnica
...
results = orch.run_pipeline(["12_review", "security"], ctx)
for r in results:
...
## Referências
- Ver `framework/Governance/12_review.py` para implementação
