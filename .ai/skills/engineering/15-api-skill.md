...
## Quando Usar
- Quando precisar de design de apis
...
results = orch.run_pipeline(["15_api", "security"], ctx)
for r in results:
...
## Referências
- Ver `framework/Engineering/15_api.py` para implementação
